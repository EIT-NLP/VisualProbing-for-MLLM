...
# added by haoran
from mobilevlm.model.siglip_encoder import SigLipVisionTower
from mobilevlm.model.dino_encoder import DinoVisionTower
from mobilevlm.model.clip_convnext_encoder import CLIPConvNextTower
###########################
    ...
    if is_absolute_path_exists or vision_tower.startswith("openai") or vision_tower.startswith("laion"):
        ...
        if vision_tower_type == "clip":
            ...
            if is_absolute_path_exists or vision_tower.startswith("google"):
                return SigLipVisionTower(vision_tower, vision_tower_cfg=model_cfg, **kwargs)
        elif vision_tower_type == "dinov2":
            print('using dinov2 encoder!!')
            return DinoVisionTower(vision_tower, args=model_cfg, **kwargs)
        elif "convnext" in vision_tower.lower():
            print(f"Loading ConvNeXt CLIP Vision Tower: {vision_tower}")
            return CLIPConvNextTower(vision_tower, args=model_cfg, **kwargs)
        else:
            raise "Please spe[cifiy visual_tower_type"
