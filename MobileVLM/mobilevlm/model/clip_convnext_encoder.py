...
def extract_res_interp(model_name):
    ...
    #     "clip-convnext-L":"CLIP-convnext_large_d_320.laion2B-s29B-b131K-ft-soup",
    #     "clip-convnext-XXL":"hf-hub:laion/CLIP-convnext_xxlarge-laion2B-s34B-b82K-augreg-soup"
    # }
    # # /code/chr/download/CLIP-convnext_large_d_320.laion2B-s29B-b131K-ft-soup
...
class CLIPConvNextTower(BaseVisionTower):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            print("The vision tower is :",vision_tower)
            assert "clip-convnext-L" in vision_tower or "clip-convnext-XXL" in vision_tower or "convnext_large" in vision_tower
            if "clip-convnext-L" in vision_tower or "convnext_large" in vision_tower:
    ...
    def load_model(self, device_map=None):
        ...
        print("999999999",self.vision_tower_name)
        self.vision_tower_name = 'convnext_large_d_320'
        clip_model, _, processor = create_model_and_transforms(self.vision_tower_name)
        # import pdb
        # pdb.set_trace()
