...
# Add arguments
parser.add_argument('--openai_api_key', default="sk-xxxxxxxxxxxxxxxxxxxc", help='Your OpenAI API key')
parser.add_argument('--answer_file', default="", help='Path to the JSONL file')
...
client = OpenAI(api_key=args.openai_api_key, base_url="https://api.chatanywhere.tech/v1")
